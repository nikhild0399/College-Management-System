...
.container .card {
	...
	width: 270px;
	height: 350px;
	background: rgba(0, 0, 0, 0.651) 50%;
	margin: 20px;
...
<nav class="navbar navbar-inverse">
    ...
    <div class="circles">
	<section>
  <div style="width:900px;height:100px;border:5px solid #000;"><center><h1>Welcome To The Staff Corner</h1></center></div>
		...
		<div class="container">
			<div class="card">
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="staff.php"><input type="button" name="submit1" value="Open"></a>
      ...
      <div class="card">
          ...
          <img src="https://i.ibb.co/9HPD3hg/Whats-App-Image-2022-03-29-at-16-27-32.jpg" >
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="updatestaff.php"><input type="button" name="submit1" value="Open"></a>
    ...
    <br>
			<div class="card">
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="staffdisplay.php"><input type="button" name="submit1" value="Open"></a>
          </div>
					</li>
            ...
            <div class="card">
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="searchstaff.php"><input type="button" name="submit1" value="Open"></a>
          </div>
					</li>
      ...
      <div class="card">
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="studentdeleterecord.php"><input type="button" name="submit1" value="Open"></a>
