...
<div class="button">
<input type="submit" name="submit5" value="Incomplete ">
</div>
<div class="button">
<input type="submit" name="submit6" value="Transferred">
</div>
<div class="button">
<input type="submit" name="submit7" value="Passout">
</div>
...
{
$res=mysqli_query($link,"SELECT * from incomplete");
echo"<table border=5>";
echo"<center>";
echo"<tr>";
echo"<th>";  echo"Roll No.";  echo"</th>";
...
{
$res=mysqli_query($link,"SELECT * from exstudent");
echo"<table border=5>";
echo"<center>";
echo"<tr>";
echo"<th>";  echo"Roll No.";  echo"</th>";
