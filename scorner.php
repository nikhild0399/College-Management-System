...
<nav class="navbar navbar-inverse">
    ...
    <div class="circles">
	<section>
  <div style="width:1000px;height:100px;border:5px solid #000;"><center><h1>Welcome To The Student Corner</h1></center></div>
 <br>
		<div class="container">
			<div class="card">
				<div class="content">
				...
				<ul class="sci">
					<li>
          <div class="button">
            <a href="student.php"><input type="button" name="submit1" value="Open"></a>
        </div>
					</li>
      ...
      <div class="card">
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="updatestudent.php"><input type="button" name="submit1" value="Open"></a>
			...
			<div class="card">
				<div class="content">
					<div class="imgBx">
						<img src="https://i.ibb.co/SrT5VWL/Whats-App-Image-2022-03-21-at-15-45-28.jpg" >
					</div>
					<div class="contentBx">
					<h3>Display</h3>
					</div>
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="displaystudent.php"><input type="button" name="submit1" value="Open"></a>
          </div>
            ...
            <div class="card">
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="studentsearch.php"><input type="button" name="submit1" value="Open"></a>
...
<div class="card">
				<div class="content">
					<div class="imgBx">
						<img src="https://i.ibb.co/QFSMnJK/360-F-101438725-su-BZGaf0-UYs-Qhr-D6a-Ry-T7-Ih-Vglufq-E0-Y.webp">
					</div>
					<div class="contentBx">
					<h3>Move</h3>
					</div>
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="staffdeleterecord.php"><input type="button" name="submit1" value="Open"></a>
        ...
        <div class="card">
				<div class="content">
					<div class="imgBx">
						<img src="https://i.ibb.co/2jS9BMF/images.png" >
					</div>
					<div class="contentBx">
					<h3>Placement</h3>
					</div>
				...
				<ul class="sci">
					<li>
          <div class="button">
          <a href="place.php"><input type="button" name="submit1" value="Open"></a>
          </div>
