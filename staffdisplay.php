...
<div class="container">
    <div class="title">Display Records</div>
    <div class="content">
        <form name ="forml" action=""  method="post"> 
        <div class="user-details">
<div class="button">
<input type="submit" name="submit4" value="Regular">
        </div>
        <div class="button">
<input type="submit" name="submit5" value="Retired">
        </div>
        <div class="button">
<input type="submit" name="submit6" value="deputed">
        </div>
        <div class="button">
<input type="submit" name="submit7" value="Transferred">
        </div>
</table>
</form>
</body>
...
echo"<th>";  echo"Father's Name\Husband's Name";  echo"</th>";
...
echo"<td>";  echo $row["nbank_name"];  echo"</td>";
...
{
$res=mysqli_query($link,"SELECT * from retirement");
echo"<table border=5>";
echo"<tr bgcolor=white>";
echo"<th >";  echo"Teacher Id";  echo"</th>";
echo"<th>";  echo"Name";  echo"</th>";
...
{
$res=mysqli_query($link,"SELECT * from deputation");
echo"<table border=5>";
echo"<tr bgcolor=white>";
echo"<th >";  echo"Teacher Id";  echo"</th>";
echo"<th>";  echo"Name";  echo"</th>";
...
{
$res=mysqli_query($link,"SELECT * from transfer");
echo"<table border=5>";
echo"<tr bgcolor=white>";
echo"<th >";  echo"Teacher Id";  echo"</th>";
echo"<th>";  echo"Name";  echo"</th>";
