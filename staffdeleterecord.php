...
<div class="container">
    <div class="title">Retirement/Deputation/Transfer Staff Records</div>
    <div class="content">
...
<div class="button">
<input type="submit" name="submit2" value="Retirement">
        </div>&nbsp;&nbsp;&nbsp;
        <div class="button">
<input type="submit" name="submit3" value="Deputation">
        </div>&nbsp;&nbsp;&nbsp;
        <div class="button">
<input type="submit" name="submit4" value="Transferred">
        </div>
</table>
</form>
</body>
...
{
$query = mysqli_query($link,"INSERT INTO retirement  SELECT * from staff where teacher_id='$_POST[teacher_id]'");
if($query)
{

  $del=mysqli_query($link,"DELETE from staff where teacher_id='$_POST[teacher_id] '");
}
echo "Your Record has been Successfully Transfer to Retirement Records ";
}
if (isset ($_POST["submit3"]))
{
$query = mysqli_query($link,"INSERT INTO deputation  SELECT * from staff where teacher_id='$_POST[teacher_id]'");
if($query)
{

  $del=mysqli_query($link,"DELETE from staff where teacher_id='$_POST[teacher_id] '");
}
echo "Your Record has been Successfully Transfer to Deputation Records";
}
if (isset ($_POST["submit4"]))
{
$query = mysqli_query($link,"INSERT INTO transfer  SELECT * from staff where teacher_id='$_POST[teacher_id]'");
if($query)
{
